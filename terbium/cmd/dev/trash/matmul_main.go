...
func main() {
	...
	// Important:
	// This creates only a declaration because we do NOT add blocks to it.
	//
	...
	// This call targets the declaration.
	// llvm-link will later resolve it against matmul_impl.ll's definition.
